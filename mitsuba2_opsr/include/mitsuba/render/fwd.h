...
template <typename Float, typename Spectrum> class Path; // #Add by Weier
...
template <typename Float_, typename Spectrum_> struct RenderAliases {
    ...
    using Path                   = mitsuba::Path<FloatU, SpectrumU>; // #Add by Weier
...
#define MTS_IMPORT_OBJECT_TYPES()                                                                  \
    ...
    using Path                 = typename RenderAliases::Path; // #Add by Weier
