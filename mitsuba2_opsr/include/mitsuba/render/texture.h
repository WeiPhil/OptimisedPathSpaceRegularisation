...
public:
    ...
    /// Evaluate the texture at the given surface interaction, with color
    /// processing.
    virtual UnpolarizedSpectrum eval(const Interaction3f &si,
                                     Mask active = true) const;

    /// Evaluate this texture as a single-channel quantity.
    virtual Float eval_1(const Interaction3f &si, Mask active = true) const;

    /// Evaluate this texture as a three-channel quantity with no color
    /// processing (e.g. normal map).
    ...
    eval_gradient(const Interaction3f &it, Mask active = true) const;
...
protected:
    ...
    virtual Mask is_inside(const Interaction3f &it,
