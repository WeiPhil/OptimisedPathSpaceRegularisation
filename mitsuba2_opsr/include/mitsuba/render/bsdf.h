...
public:
    ...
    sample(const BSDFContext &ctx, const SurfaceInteraction3f &si,
           Float sample1, const Point2f &sample2, Mask active = true) const = 0;
    ...
    // #Add by Weier
    virtual Spectrum eval_rough(const BSDFContext &ctx,
    ...
    // #Add by Weier
    virtual Float pdf_rough(const BSDFContext &ctx,
                            const SurfaceInteraction3f &si, const Vector3f &wo,
                            const Vector2f & /*acc_roughness*/,
                            Mask active = true) const {
    ...
    // #Add by Weier
    virtual Vector2f get_roughness(const SurfaceInteraction3f & /*si*/,
                                   Mask /*active*/) const {
        // Making sure this is implemented on a brdf that is "roughening aware"
        NotImplementedError("get_roughness");
    }

    // #Add by Weier
    virtual Float get_eta(const SurfaceInteraction3f & /*si*/,
                          Mask /*active*/) const {
        // Making sure this is implemented on a brdf that is "roughening aware"
        NotImplementedError("get_eta");
    }

    // #Add by Weier
    virtual Float get_inv_eta(const SurfaceInteraction3f & /*si*/,
                              Mask /*active*/) const {
        // Making sure this is implemented on a brdf that is "roughening aware"
        NotImplementedError("get_inv_eta");
    }
...
ENOKI_CALL_SUPPORT_TEMPLATE_BEGIN(mitsuba::BSDF)
    ...
    // #Add by Weier
    ENOKI_CALL_SUPPORT_METHOD(sample_rough)
    ENOKI_CALL_SUPPORT_METHOD(eval_rough)
    ENOKI_CALL_SUPPORT_METHOD(pdf_rough)
    ENOKI_CALL_SUPPORT_METHOD(get_roughness)
    ENOKI_CALL_SUPPORT_METHOD(get_eta)
    ENOKI_CALL_SUPPORT_METHOD(get_inv_eta)
